...
CR .( Loading FPOUT v3.3  19-Nov-07 ... ) CR
...
\ test if system supports "negative zero"
-0.E0 PAD 1 REPRESENT DROP  TO sn#  DROP
...
: (f3)  ( F: r -- ) ( places -- c-addr u flag )
  ...
  THEN  DUP TO sn#  0 MAX  PRECISION MIN
  fbuf SWAP REPRESENT >R
  [ sn# 0= ] [IF]  sn# 0< 0= AND  [THEN] ( sign )
